...
function MovieCard({ movie }) {
  ...
  return (
    ...
    >
      <div
        style={{ position: "relative", height: "240px", background: "#1a1a2e" }}
      >
        {poster ? (
          <img
            src={poster}
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <a href="/" className="text-2xl font-bold hover:text-gradient">
            Movie Man
          </a>
        </div>
            ...
            {SORT_OPTIONS.map((opt) => (
              <button
                ...
                style={{
                  ...
                  color:
                    sortBy === opt.value ? "#fff" : "rgba(255,255,255,0.55)",
                  fontSize: "12px",
                  fontWeight: 600,
                  padding: "6px 14px",
                  borderRadius: "8px",
        ...
        {loading ? (
          ...
          >
            {movies.map((m) => (
              <div
                key={m.id}
                onClick={() => setSelectedMovie(normalizeMovieForModal(m))}
              >
                <MovieCard movie={m} />
              </div>
            ))}
                ...
                style={{
                  background:
                    p === page
                      ...
                      : "rgba(255,255,255,0.05)",
                  border:
                    p === page ? "none" : "1px solid rgba(255,255,255,0.1)",
